...
<head>
    ...
    <style>
        :root {
            ...
            --btn-theme-hover-text-color: {
                    {
                    $nav_link_color ?? 'light-dark(hsl(from var(--main-theme-color) h s calc(l - 10)),hsl(from var(--main-theme-color) h s calc(l - 10)))'
                }
            }
            ...
            --main-theme-color: {
                    {
                    $snipeSettings->header_color ?? '#5fa4cc'
                }
            }
        ...
        .navbar-nav>.messages-menu>.dropdown-menu>li .menu,
        .navbar-nav>.tasks-menu>.dropdown-menu>li .menu a:hover,
        .navbar-nav>.messages-menu>.dropdown-menu>li .menu,
...
<body class="sidebar-mini{{ (session('menu_state')!='open') ? ' sidebar-mini sidebar-collapse' : ''  }}">
    ...
    <script nonce="{{ csrf_token() }}">
        ...
        function updateButton({
            ...
            const newCta = isDark ? '<i class="fa-regular fa-sun fa-fw"></i>  {{ trans('
            general.light_mode ') }}': '<i class="fa-solid fa-moon fa-fw"></i>   {{ trans('
            general.dark_mode ') }}';
        ...
        clipboard.on('success', function(e) {
            ...
            clickedElement.tooltip('hide').attr('data-original-title', '{{ trans('
                general.copied ') }}').tooltip('show');
        });
